  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '28px 24px' }}>
      ...
      <Section title="What each check looks for">
        ...
        <Check icon={BookOpen} severity="critical" title="Readability score" desc="Uses the Flesch-Kincaid formula to score how easy an article is to read (0–100). Below 50 is a warning; below 30 is critical. Long sentences, passive voice, and technical jargon all lower the score. Note: readability and AI Quality Score measure different things — an article can have low readability (hard to read) but a high quality score (well structured and complete). Low readability means customers may struggle to follow the steps even if the content is correct. Use Improve Article to simplify the language without changing the meaning." />
      ...
      <Section title="Frequently asked questions">
        ...
        <FAQ q="My article has a low readability score but a high AI Quality Score — which should I trust?"
          a={<span>Both are right — they measure different things. <strong>Readability</strong> measures how easy the writing is to follow: sentence length, word complexity, passive voice. <strong>Quality Score</strong> measures the overall article: structure, completeness, clarity of purpose, and whether it genuinely helps the reader. An article can score 85 on quality (well-organised, thorough, answers the question) but 29 on readability (sentences too long, too much jargon). The fix is to simplify the language without changing the content — which is exactly what <strong>Improve Article</strong> does. Run it and re-scan to see the readability score improve.</span>} />

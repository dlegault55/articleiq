    ...
    <div style={{ background: '#F0F5F0', borderRadius: 16, padding: 20, border: '1px solid #D4E8D4', boxShadow: '0 24px 64px rgba(0,0,0,0.12)' }}>
      ...
      <div style={{ background: '#107C10', borderRadius: 14, padding: '18px 20px', marginBottom: 12, position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', gap: 12, marginBottom: 10 }}>
          <div style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontSize: 56, fontWeight: 800, color: 'white', lineHeight: 1, letterSpacing: -2 }}>61</div>
...
export default function LandingPage() {
  return (
    <div style={{ fontFamily: "'Instrument Sans', system-ui, sans-serif", background: 'white', color: '#0F1F0F', minHeight: '100vh' }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Plus Jakarta Sans:wght@700;800&family=Instrument+Sans:wght@400;500;600&display=swap');
      ...
      <nav style={{ position: 'sticky', top: 0, zIndex: 100, background: 'rgba(255,255,255,0.9)', backdropFilter: 'blur(12px)', borderBottom: '1px solid #E5E7EB', padding: '0 40px', height: 56, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontWeight: 800, fontSize: 16, letterSpacing: -0.3 }}>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '72px 40px 60px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'center' }}>
        <div>
          ...
          <h1 style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontWeight: 800, fontSize: 36, lineHeight: 1.1, letterSpacing: -1.5, color: '#0F1F0F', marginBottom: 20 }}>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 32, justifyContent: 'center', flexWrap: 'wrap' }}>
          {['Scans completed every day', 'Articles analyzed', 'Issues caught automatically'].map((s, i) => (
            <div key={s} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <span style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontWeight: 800, fontSize: 22, color: '#107C10' }}>
                {['500+', '50k+', '12k+'][i]}
              </span>
      ...
      <section style={{ maxWidth: 860, margin: '0 auto', padding: '80px 40px' }}>
        <div style={{ textAlign: 'center', marginBottom: 56 }}>
          <h2 style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontWeight: 800, fontSize: 34, letterSpacing: -1, marginBottom: 14 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 20 }}>
          {[
            ...
            <div key={title} style={{ padding: '24px', background: bg, border: `1px solid ${border}`, borderRadius: 16 }}>
              ...
              <p style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontWeight: 700, fontSize: 16, marginBottom: 8, color: '#0F1F0F' }}>{title}</p>
      ...
      <section style={{ background: '#F0F5F0', borderTop: '1px solid #D4E8D4', borderBottom: '1px solid #D4E8D4', padding: '80px 40px' }}>
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 52 }}>
            <h2 style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontWeight: 800, fontSize: 34, letterSpacing: -1, marginBottom: 12 }}>Up and running in minutes</h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 24 }}>
            {[
              ...
              <div key={step} style={{ background: 'white', borderRadius: 16, padding: '28px 24px', border: '1px solid #D4E8D4', position: 'relative' }}>
                <div style={{ position: 'absolute', top: 20, right: 20, fontFamily: 'Plus Jakarta Sans, sans-serif', fontWeight: 800, fontSize: 28, color: '#D4E8D4', lineHeight: 1 }}>{step}</div>
                ...
                <p style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontWeight: 700, fontSize: 16, marginBottom: 8 }}>{title}</p>
                <p style={{ fontSize: 13, color: '#4A5E4A', lineHeight: 1.7 }}>{desc}</p>
              </div>
            ))}
          </div>
      ...
      <section style={{ maxWidth: 860, margin: '0 auto', padding: '80px 40px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 40, alignItems: 'center' }}>
          <div>
            <h2 style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontWeight: 800, fontSize: 32, letterSpacing: -1, marginBottom: 24, lineHeight: 1.2 }}>
          ...
          <div style={{ background: '#F0F5F0', borderRadius: 16, padding: 24, border: '1px solid #D4E8D4' }}>
            ...
            <div style={{ background: '#107C10', borderRadius: 12, padding: '20px 20px 16px', marginBottom: 12 }}>
              ...
              <div style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontSize: 64, fontWeight: 800, color: 'white', lineHeight: 1, letterSpacing: -2, marginBottom: 4 }}>74</div>
      ...
      <section style={{ background: '#107C10', padding: '72px 40px', textAlign: 'center' }}>
        <div style={{ position: 'relative', maxWidth: 600, margin: '0 auto' }}>
          <h2 style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontWeight: 800, fontSize: 36, color: 'white', letterSpacing: -1, marginBottom: 16, lineHeight: 1.2 }}>
      ...
      <footer style={{ background: '#0A1A0A', padding: '24px 40px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontWeight: 800, fontSize: 14, color: 'white', letterSpacing: -0.3 }}>

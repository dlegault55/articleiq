    ...
    <div style={{ maxWidth: 720, margin: '0 auto', padding: 'clamp(16px,4vw,28px) clamp(16px,4vw,24px)' }}>
      ...
      <div style={{ marginBottom: 40 }}>
        ...
        <FAQ q="My article has a low readability score but a high AI Quality Score — which should I trust?"
          a={<span>Both are right — they measure different things. <strong>Readability</strong> measures how easy the writing is to follow: sentence length, word complexity, passive voice. <strong>Quality Score</strong> measures the overall article: structure, completeness, and whether it genuinely helps the reader. Use <strong>Improve Article</strong> to simplify the language — it should raise the readability score on the next scan.</span>} />
